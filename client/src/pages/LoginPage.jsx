      ...
      {/*------------------------------------left-----------------------------------------*/}
        ...
        <h2 className='font-medium text-2xl flex justify-between items-center'>
          ...
          {currState==='Sign up' && !isDataSubmitted && (
            <input  value={fullName} type="text" className='p-2 border border-gray-500 rounded-md focus:outline-none' placeholder='Full Name' required onChange={(e)=>setFullName(e.target.value)}/>
          )}
